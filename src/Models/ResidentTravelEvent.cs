    ...
    internal sealed class ResidentTravelEvent
    {
        ...
        public override string ToString()
        {
            return string.Format(
                ...
                "CapturedAtUtc={0:o}; Traveler={1}; CitizenId={2}; Reason={3}; Origin=({4:F2},{5:F2},{6:F2})[{7}]; Destination=({8:F2},{9:F2},{10:F2})[{11}]; Buildings(H={12},W={13},V={14},O={15},D={16}); Offer={17}/{18};",
                ...
                OfferObjectType, OfferObjectRaw);
        }
    }
}
